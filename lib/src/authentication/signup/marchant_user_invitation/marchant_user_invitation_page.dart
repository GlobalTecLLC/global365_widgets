...
class MarchantUserInvitationPage extends StatefulWidget {
  final String invitationCode;
  const MarchantUserInvitationPage({super.key, required this.invitationCode});

  @override
  State<MarchantUserInvitationPage> createState() => _MarchantUserInvitationPageState();
}

class _MarchantUserInvitationPageState extends State<MarchantUserInvitationPage> {
  final MarchanUserInvitationController userInvitationController = Get.put(MarchanUserInvitationController());
