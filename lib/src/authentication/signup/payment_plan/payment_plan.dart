                                      ...
                                      : Column(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: GLabelSemiBold("Chat & Email Support").marginOnly(left: 5),
                                              ),
                                            ),
                                            Container(
                                              height: 28,
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: lightBackground3,
                                                borderRadius: BorderRadius.circular(1),
                                                border: const Border(bottom: BorderSide(color: Color(0xffc4d2d8))),
                                              ),
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: GLabelSemiBold("Additional User Access").marginOnly(left: 5),
                                              ),
                                            ),
                                            SizedBox(
                                              height: 34,
                                            ...
                                            Container(
                                              ...
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: GLabelSemiBold("Recommended Add-Ons").marginOnly(left: 5),
                                              ),
                                            ),
                                              ...
                                              child: Align(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    GLabelSemiBold("Add Additional Entities").marginOnly(left: 5),
                                                    const Spacer(),
                                                    Obx(
                                                      () => Padding(
                                        ...
                                        children: [
                                          ...
                                          GTextHeading1(
                                            controller.isYearlyplanActive.isFalse
                                                ...
                                                : GAmountFunctions.formateAmount(
                                                    controller.subscriptionPlansFirstList.value["yearlyDisplayPrice"] ??
                                                        "",
                                                    addCurrency: true,
                                                  ),
                                            color: primaryColor,
                                          ...
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: GParagraph13("Start 15-Days Free Trial", color: Colors.white),
                                              ),
                                            ),
                                          ),
                                          GSizeH(10),
                                            ...
                                            () => controller.isPlansListLoading.isTrue
                                                ...
                                                : Container(
                                                    ...
                                                    child: ListView.builder(
                                                      itemCount:
                                                          (controller.subscriptionPlansFirstList.value["addOns"] ?? [])
                                                              .length,
                                                              ...
                                                              children: [
                                                                ...
                                                                CustomSwitch(
                                                                  ...
                                                                  onChanged: (value) {
                                                                    ...
                                                                    GToast.info(context, "This action can not be done");
                                                                  },
                                                                ),
                                                              ],
                                                            ),
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                const Divider(color: Color(0xffbbbbbb)).marginSymmetric(horizontal: 15),
                                                Padding(
                                                  padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                                  child: GParagraphNormal(
                                                    controller.subscriptionPlansFirstList.value["description"] ?? "",
                                                  ),
                                                ),
                                                GSizeH(10),
                                              ],
