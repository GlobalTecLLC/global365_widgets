...
class _CurrencyDropdownState extends State<CurrencyDropdown> {
  @override
  void initState() {
    gLogger("List is ${BusinessProfileController.to.currenciesList}");
  ...
  Future<void> fetchData() async {
    if (BusinessProfileController.to.currenciesList.isEmpty) {
      setState(() {
        isLoading = false;
      });
      ...
      APIsCallGet.getData("Config/GetConfigs").then((response) {
        ...
        if (response.statusCode == 200) {
          ...
          List parsed = payLoad['payload']['currencies'];
          ...
          setState(() {
            listItems = tempNew;
            BusinessProfileController.to.currenciesList.value = tempNew;
          });
      ...
      final parsed = BusinessProfileController.to.currenciesList;
      List tempNew = isNotHistory
          ? []
          : [
              {"value": "0", "label": "All"},
