...
class IndustryDropdownForPayroll extends StatefulWidget {
  ...
  @override
  State<IndustryDropdownForPayroll> createState() => _IndustryDropdownForPayrollState();
}

class _IndustryDropdownForPayrollState extends State<IndustryDropdownForPayroll> {
  @override
  void initState() {
  ...
  Future<void> fetchData() async {
    if (BusinessProfileController.to.industryList.isEmpty) {
      ...
      APIsCallGet.getData("PayrollConfig/GetIndustryType").then((response) {
