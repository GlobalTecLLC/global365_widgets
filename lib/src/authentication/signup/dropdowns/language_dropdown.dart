...
class _LanguageDropdownState extends State<LanguageDropdown> {
  @override
  void initState() {
    gLogger("List is ${BusinessProfileController.to.languagesList}");
  ...
  Future<void> fetchData() async {
    if (BusinessProfileController.to.languagesList.isEmpty) {
      setState(() {
        isLoading = false;
      });
      ...
      ApiCalls.getAPICall(context, url: "Config/GetConfigs").then((response) {
        ...
        if (response.statusCode == 200) {
          ...
          List parsed = payLoad['payload']['languages'];
          ...
          setState(() {
            listItems = tempNew;
            BusinessProfileController.to.languagesList.value = tempNew;
          });
      ...
      final parsed = BusinessProfileController.to.languagesList;
      List tempNew = isNotHistory
          ? []
          : [
              {"value": "0", "label": "All"},
