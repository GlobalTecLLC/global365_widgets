...
class SoftwareInfoController extends GetxController {
  ...
  signUp(context) async {
    ...
    dynamic data = {
      ...
      "locationId": SetUpController.to.locationDropdown.value.toString() == "null"
          ? 0
      ...
      "stateId": BusinessProfileController.to.stateDropdown.value.toString() == "null"
          ? 0
