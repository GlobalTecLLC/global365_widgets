...
class CpaRedirectLogin extends StatelessWidget {
  const CpaRedirectLogin({required this.redirectcode, super.key});
  final String redirectcode;
  @override
  Widget build(BuildContext context) {
    gLogger("CPA Redirect Login $redirectcode");
    LoginController.to.redirectFromCPA(context, redirectcode);
            ...
            children: [
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Center(
                              child: Image(
                                image: const AssetImage(AppAssets.globalGroupLogoLoginImg),
                                width: 100,
                                height: 100,
                              ),
                            ),
              ...
              Positioned.fill(
                ...
                child: Align(
                  ...
                  child: SvgPicture.asset(AppAssets.poweredByLogoWhiteIcon),
                ),
              ),
            ],
          ),
