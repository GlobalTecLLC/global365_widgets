...
class RawDelightToastState extends State<RawDelightToast> {
  ...
  Widget build(BuildContext context) {
    return AnimatedPositioned(
      ...
      top: widget.snackbarPosition == DelightSnackbarPosition.top ? widget.getPosition() + 70 : null,
      bottom: widget.snackbarPosition == DelightSnackbarPosition.bottom ? widget.getPosition() + 70 : null,
      left: 0,
      right: 0,
      child: Material(
