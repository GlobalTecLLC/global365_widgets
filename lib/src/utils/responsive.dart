...
class Responsive extends StatelessWidget {
  ...
  static bool isBigDesktopDesktop(BuildContext context) => MediaQuery.of(context).size.width >= 1300;

  static bool issmallDesktopDesktop(BuildContext context) =>
      MediaQuery.of(context).size.width < 1300 && MediaQuery.of(context).size.width >= 1100;
